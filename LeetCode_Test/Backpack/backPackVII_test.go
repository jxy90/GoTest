...
func Test_backPackVII(t *testing.T) {
	println(backPackVII(8, []int{3, 2}, []int{300, 160}, []int{1, 6}))
	println(backPackVII(8, []int{2, 4}, []int{100, 100}, []int{4, 2}))
	println(backPackVII(54, []int{10, 8, 8, 3, 13, 5, 10, 6, 11, 7, 3, 20, 15, 14, 20, 9, 7, 16, 13, 15}, []int{78, 74, 8, 56, 91, 177, 159, 66, 62, 143, 102, 195, 27, 199, 141, 21, 106, 122, 147, 76}, []int{3, 19, 3, 15, 2, 14, 5, 16, 10, 11, 10, 15, 10, 1, 18, 16, 2, 1, 14, 15}))
}
