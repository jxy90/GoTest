...
#./deployblack.sh 10.231.105.97 jinyu_3F_entry_time false
...
for uuid in $uuids; do
  ...
  data="{\"list\":[{\"channelUuid\":\"${uuid}\",\"algoType\":\"glider-faced-video-share\",\"config\":{\"faceDeploy\":{\"customSettings\":{\"mode\":2},\"enable\":${en},\"facePedBind\":false,\"groupUuids\":[\"PG-0d27ab7bd2bd476e926c\"],\"ruleCustomName\":\"人脸\",\"ruleId\":1}}}]}"
